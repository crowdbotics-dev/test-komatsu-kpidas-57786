...
## Project Structure
    ...
    ├── test_komatsu_kpidas_57786  # Django project configurations
...
1. Clone this repo and `cd test_komatsu_kpidas_57786`
...
2. Clone this repo and `cd test_komatsu_kpidas_57786`
